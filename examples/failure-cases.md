...
- **Non-independent review:** a fictional medium-risk change packet reports the same runtime and execution reference for worker and reviewer and grants write access. Cross-document validation rejects the review before its verdict can be admitted; high risk follows the same rule.
